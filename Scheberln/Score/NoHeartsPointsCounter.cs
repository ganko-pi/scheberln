...
public class NoHeartsPointsCounter : IPointsCounter
{
    ...
    public Dictionary<IPlayer, int> CountPointsAfterDeal(GameState gameState)
    {
        ...
        {
            throw new ArgumentException($"The \"{allPlayedCardsInDeal.GetType()}\" passed to {nameof(NoHeartsPointsCounter)}.{nameof(CountPointsAfterDeal)} in {nameof(gameState)}.{nameof(GameState.AllPlayedCardsInDeal)} does include null which is not valid for the objective \"{Objective}\".");
        }
