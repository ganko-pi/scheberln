...
/// <summary>
/// Implementation of <see cref="IPlayValidator"/> representing a validator if a play is allowed for a deal with <see cref="Objective"/> <see cref="Objective.NoHeartsKing"/>.
/// </summary>
public class NoHeartsKingPlayValidator : IPlayValidator
{
    ...
    /// <summary>
    /// Constructor for <see cref="NoHeartsKingPlayValidator"/>.
    /// </summary>
    /// <param name="playConstraintFullfilledChecker">Class for checking if all <see cref="IConstraint"/>s are fullfilled.</param>
    public NoHeartsKingPlayValidator(IPlayConstraintFullfilledChecker playConstraintFullfilledChecker)
    {
