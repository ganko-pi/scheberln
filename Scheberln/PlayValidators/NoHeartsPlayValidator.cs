...
/// <summary>
/// Implementation of <see cref="IPlayValidator"/> representing a validator if a play is allowed for a deal with <see cref="Objective"/> <see cref="Objective.NoHearts"/>.
/// </summary>
public class NoHeartsPlayValidator : IPlayValidator
{
    ...
    public List<IConstraint> PlayConstraints { get; } = new()
    {
        ...
        new NoHeartsAsFirstCardInDealPlayConstraint(),
    };

    /// <summary>
    /// Constructor for <see cref="NoHeartsPlayValidator"/>.
    /// </summary>
    /// <param name="playConstraintFullfilledChecker">Class for checking if all <see cref="IConstraint"/>s are fullfilled.</param>
    public NoHeartsPlayValidator(IPlayConstraintFullfilledChecker playConstraintFullfilledChecker)
    {
