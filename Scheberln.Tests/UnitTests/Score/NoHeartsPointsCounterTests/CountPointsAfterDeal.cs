...
namespace Scheberln.Tests.UnitTests.Score.NoHeartsPointsCounterTests;
...
public class CountPointsAfterDeal
{
    ...
    public void TestCountPointsAfterDeal_WhenCalledWithValidGameState_CountsPointsCorrectly()
    {
        ...
        NoHeartsPointsCounter noHeartsPointsCounter = new();

        // act
        Dictionary<IPlayer, int> actualPoints = noHeartsPointsCounter.CountPointsAfterDeal(gameState);
    ...
    public void TestCountPointsAfterDealTwice_WhenCalledWithValidGameState_CountsPointsCorrectly()
    {
        ...
        // act
        noHeartsPointsCounter.CountPointsAfterDeal(gameState);
        Dictionary<IPlayer, int> actualPoints = noHeartsPointsCounter.CountPointsAfterDeal(gameState);
    ...
    public void TestCountPointsAfterDeal_WhenCalledWithWrongObjective_ThrowsArgumentException()
    {
        ...
        // act/assert
        ArgumentException thrownException = Assert.Throws<ArgumentException>(() => noHeartsPointsCounter.CountPointsAfterDeal(gameState));

        Assert.That(thrownException.Message, Is.EqualTo("The objective \"NoObers\" passed to CountPointsAfterDeal in gameState.CurrentObjective does not match the objective \"NoHearts\" of class NoHeartsPointsCounter."));
    }
    ...
    public void TestCountPointsAfterDeal_WhenCalledWithNullObjective_ThrowsArgumentException()
    {
        ...
        Assert.That(thrownException.Message, Is.EqualTo("The objective \"\" passed to CountPointsAfterDeal in gameState.CurrentObjective does not match the objective \"NoHearts\" of class NoHeartsPointsCounter."));
    }
    ...
    public void TestCountPointsAfterDeal_WhenCalledWithNullDealer_ThrowsArgumentException()
    {
        ...
        Assert.That(thrownException.Message, Is.EqualTo("Dealer in NoHeartsPointsCounter.CountPointsAfterDeal is null."));
    }
    ...
    public void TestCountPointsAfterDeal_WhenCalledWithNullInCards_ThrowsArgumentException()
    {
        ...
        Assert.That(thrownException.Message, Is.EqualTo("The \"System.Collections.Generic.List`1[Scheberln.Cards.Card]\" passed to NoHeartsPointsCounter.CountPointsAfterDeal in gameState.AllPlayedCardsInDeal does include null which is not valid for the objective \"NoHearts\"."));
    }
}
