...
public class IsFullfilled
{
    ...
    [Test]
    public void TestIsFullfilled_NoConstraints_ReturnsTrue()
    {
        // arrange
    ...
    [Test]
    public void TestIsFullfilled_FirstTrueThenFalseConstraint_ReturnsFalse()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeFalseConstraint falseConstraint0 = new();
    ...
    [Test]
    public void TestIsFullfilled_FirstFalseThenTrueConstraint_ReturnsFalse()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeFalseConstraint falseConstraint0 = new();
    ...
    [Test]
    public void TestIsFullfilled_OneFalseAtFirstSevenTrueConstraints_ReturnsFalse()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeTrueConstraint trueConstraint1 = new();
    ...
    [Test]
    public void TestIsFullfilled_OneFalseAtSecondSevenTrueConstraints_ReturnsFalse()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeTrueConstraint trueConstraint1 = new();
    ...
    [Test]
    public void TestIsFullfilled_OneFalseAtEighthSevenTrueConstraints_ReturnsFalse()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeTrueConstraint trueConstraint1 = new();
