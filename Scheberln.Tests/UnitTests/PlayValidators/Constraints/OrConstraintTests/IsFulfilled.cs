...
public class IsFullfilled
{
    ...
    [Test]
    public void TestIsFulfilled_NoConstraints_ReturnsFalse()
    {
        // arrange
    ...
    [Test]
    public void TestIsFulfilled_FirstTrueThenFalseConstraint_ReturnsTrue()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeFalseConstraint falseConstraint0 = new();
    ...
    [Test]
    public void TestIsFulfilled_FirstFalseThenTrueConstraint_ReturnsTrue()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeFalseConstraint falseConstraint0 = new();
    ...
    [Test]
    public void TestIsFulfilled_OneTrueAtFirstSevenFalseConstraints_ReturnsTrue()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeFalseConstraint falseConstraint0 = new();
    ...
    [Test]
    public void TestIsFulfilled_OneTrueAtSecondSevenFalseConstraints_ReturnsTrue()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeFalseConstraint falseConstraint0 = new();
    ...
    [Test]
    public void TestIsFulfilled_OneTrueAtEighthSevenFalseConstraints_ReturnsTrue()
    {
        // arrange
        FakeTrueConstraint trueConstraint0 = new();
        FakeFalseConstraint falseConstraint0 = new();
